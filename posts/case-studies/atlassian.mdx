...
/>
<br />
<Row content1="<h3>Designing to unblock datacenter to cloud migration ☁️</h3><p>Project spanning two other teams and timezones to provide a solution for app management for enterprise companies.</p>" 
