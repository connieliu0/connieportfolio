...
2 week sprint to design a new marketing page for the first student network of the Abundance movement a bipartisan effort to build social progress. Below are some wide explorations of what this could look like for the first directional sprint.

![agents](startups/abundance.png)
